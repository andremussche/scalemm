...
begin
  Result := 'A multi-threaded benchmark that allocates and frees memory blocks. The usage of different block sizes approximates real-world usage as seen in various replays. Allocated memory is actually "used", i.e. written to and read.';
end;
